...
<table border="2px" cellpadding="20px" cellspacing="0">
    ...
    <tbody>
        <tr>
            <td>姓名</td>
            <td><input type="text" placeholder="真实姓名" id="name"></td>
            <td>性别</td>
            <td>
        ...
        <tr>
            <td>年龄</td>
            <td><label><input type="number" maxlength="2" id="age"></label></td>
            <td>学历</td>
            <td>
                <label>
                <select>
        ...
        <tr>
            <td>联系方式</td>
            <td><label><input type="text" maxlength="11" id="tel"></label></td>
            <td>E-mail</td>
        ...
        <tr>
            <td>上份工作</td>
            <td><input type="text" placeholder="请输入工作名称" id="last_job"></td>
            <td>工作经验</td>
            <td><input type="text" placeholder="请输入有几年工作经验" id="job_age"></td>
        </tr>
        <tr>
            <td>期望薪资</td>
            <td>
