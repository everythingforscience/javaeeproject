...
<form>
    <table class="table table-striped">
        ...
        <tr style="text-align: center">
            <td colspan="2"><button class="btn btn-primary" id="interview">面试</button></td>
            <td colspan="2"><button class="btn btn-primary" id="return">返回</button></td>
        </tr>
        <tr>
            <td colspan="2">面试日期</td>
            <td colspan="2"><label><input type="date" name="employ_date"></label></td>
        </tr>
        </tbody>
    </table>
</form>
